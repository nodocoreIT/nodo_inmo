  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-40 flex h-14 items-center gap-2 rounded-full bg-gradient-to-r from-brand to-brand-600 px-4 text-white shadow-lg transition-all duration-300 hover:scale-105 active:scale-95 group focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2"
        style={{
      ...
      >
        ...
        <div className="relative h-6 w-6 flex items-center justify-center">
          ...
          <img
            ...
            alt="Nodo"
            className={cn(
              "absolute inset-0 h-6 w-6 transition-all duration-500 transform",
              activeIcon === "logo"
